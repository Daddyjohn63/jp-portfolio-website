...
export const CtaButton = ({ label, href = '/' }) => {
  ...
  return (
    <Link
      className="group w-fit flex items-center gap-2 bg-transparent rounded-3xl border border-muted-foreground/50 px-3 py-2  transition-all duration-300 hover:scale-105 hover:border-accent hover:shadow-[0_0_10px_rgba(167,139,250,0.3)]"
      href={href}
    >
