            ...
            <div className="flex-1 w-full lg:w-1/2">
              <div className="w-full">
                <div className="mt-4 md:mt-0">
                  <h1 className="inline-flex text-[15px] md:text-lg xl:text-xl  items-center gap-1 font-light py-1 px-3 md:px-2 rounded-full text-white/80 bg-primary/10">
                    Freelance Web Developer in London – React & Next.js
                    Specialist
                  </h1>
                </div>
                ...
                <ul className="flex flex-col mt-3 gap-2">
                  <li className="flex items-center gap-1">
                    ...
                    Built with React, Next.js and TypeScript for fast, reliable
                    performance.
                  </li>
                  <li className="flex items-center gap-1">
                    <MoveRight className="size-5 text-muted-foreground mr-2" />
                    Server-side rendering, image optimisation, and clean code to
                    help you rank higher and convert more visitors.
                  </li>
                  <li className="flex items-center gap-1">
                    <MoveRight className="size-5 text-muted-foreground mr-2" />
                    Scalable solutions, from MVPs to complex business apps.
                  </li>
                </ul>
